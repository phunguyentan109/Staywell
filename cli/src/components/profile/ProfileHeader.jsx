        ...
        <div className='gx-profile-banner-top'>
          <div className='gx-profile-banner-top-left'>
            ...
            <div className='gx-profile-banner-avatar-info'>
              <h2 className='gx-mb-2 gx-mb-sm-3 gx-fs-xxl gx-font-weight-light'>{username}</h2>
              <p className='gx-mb-0 gx-fs-lg'>
                <PermissionRender access={['OWNER_PM']}>Owner</PermissionRender>
                <PermissionRender access={['PEOPLE_PM']}>People</PermissionRender>
              </p>
            </div>
          </div>
